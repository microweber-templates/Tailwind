...
$menu_filter['link'] = '<a itemprop="url" data-item-id="{id}" class="bg-red-500 block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700 {active_class}" href="{url}">{title}</a>';
