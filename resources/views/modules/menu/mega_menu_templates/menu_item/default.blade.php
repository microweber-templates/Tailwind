...
*/
?>
<div id="mega-menu-full-dropdown" class="hide group-hover:block bg-gray-50 md:bg-white left-0 w-full absolute mt-4 border-gray-200 shadow-xs  border-y dark:bg-gray-800 dark:border-gray-600">
