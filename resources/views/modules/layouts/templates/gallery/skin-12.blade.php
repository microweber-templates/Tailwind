        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full lg:w-7/12 mx-auto order-1 lg:order-2">
                <div class="flex flex-wrap">
                    <div class="w-full md:w-9/12 flex items-center">
                        <div class="w-full h-[300px] mb-6 overflow-hidden">
                            <img class="w-full h-full object-cover" loading="lazy" src="{{ template_url() }}img/layouts/gallery/blue/gallery-7.jpg"/>
                        </div>
                    </div>
                    <div class="w-full md:w-3/12 flex items-end">
                        <div class="aspect-square w-full mb-6 overflow-hidden">
                            <img class="w-full h-full object-cover" loading="lazy" src="{{ template_url() }}img/layouts/gallery/blue/gallery-6.jpg"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full md:w-9/12 flex items-center">
                        <div class="w-full h-[300px] mb-6 overflow-hidden">
                            <img class="w-full h-full object-cover" loading="lazy" src="{{ template_url() }}img/layouts/gallery/blue/gallery-4.jpg"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full md:w-6/12 lg:w-3/12 flex items-center order-2 lg:order-3 ml-auto mb-6 lg:mb-0 my-0 lg:my-24">
                <div class="aspect-square w-full overflow-hidden">
                    <img class="w-full h-full object-cover" loading="lazy" src="{{ template_url() }}img/layouts/gallery/blue/gallery-5.jpg"/>
                </div>
            </div>
        </div>
    </div>
